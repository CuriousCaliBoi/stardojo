...
//            }
        ...
        {
            testUtils.TestUtils.print_mouse_pos(this);
        }
        ...
        private void giveMoney(string command, string[] args)
        {
            ...
            testUtils.TestUtils.give_money(amount);
        }
        ...
        {
            testUtils.TestUtils.set_time(this);
        }
        ...
        {
            int itemId = testUtils.TestUtils.ItemIdMap[args[0]];
            int count = 1;
            if (args.Length > 1)
            {
                count = int.Parse(args[1]);
            }
            testUtils.TestUtils.give_items(itemId.ToString(), count);
        }
        ...
        private void giveItemsById(string command, string[] args)
        {
            ...
            testUtils.TestUtils.give_items(itemId, count);
        }
        ...
        {
            testUtils.TestUtils.tp_player(args[0], this);
        }

        private void giveTool(string command, string[] args)
        {
            testUtils.TestUtils.give_tool(args[0], this);
        }
        ...
        private void OnButtonPressed(object? sender, ButtonPressedEventArgs e)
        {
            ...
            if (e.Button == SButton.P)
            {
                ...
                int player_x_pos = (int)player.TilePoint.X;
                int player_y_pos = (int)player.TilePoint.Y;
                testUtils.TestUtils.add_chest(player_x_pos, player_y_pos, Color.Blue, this);
            }
